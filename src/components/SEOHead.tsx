...
/** The site-wide link preview, generated by scripts/generate-og.mjs. Bump the filename when the artwork changes. */
export const DEFAULT_OG_IMAGE = "https://www.sphpnp.com/og-sphpnp-2026.jpg";
...
const SEOHead = ({ 
  ...
  // Versioned filename: link unfurlers cache previews by URL (scripts/generate-og.mjs).
  ...
  return (
    <Helmet>
      ...
      {finalOgImage === DEFAULT_OG_IMAGE && <meta property="og:image:width" content="1200" />}
      {finalOgImage === DEFAULT_OG_IMAGE && <meta property="og:image:height" content="630" />}
      {finalOgImage === DEFAULT_OG_IMAGE && <meta property="og:image:type" content="image/jpeg" />}
