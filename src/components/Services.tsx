...
const services = [
  ...
  },
  {
    ...
    id: "derivatives",
    href: "/fno",
    description: "Futures & Options trading with research and market analysis.",
    stat: "Real-Time",
  ...
  },
  {
    ...
    description: "NSDL & CDSL Demat account with fast transfers and margin pledging.",
    stat: "NSDL · CDSL",
  ...
  },
  {
    ...
    id: "mobile-trading",
    href: "/apps",
    description: "Trade on the go with Parasram Money, our new app, or Parasram Trade.",
    stat: "100K+",
