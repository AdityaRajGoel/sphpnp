...
const teamMembers = [
  ...
  },
  {
    ...
    longBio: "Aditya Raj Goel handles client servicing with a focus on modern digital tools: paperless KYC, smooth onboarding, and an active online presence that keeps clients informed.",
    phone: "+91 8295565443",
  ...
  },
  {
    ...
    longBio: "Rajat Gupta oversees every transaction from initiation to completion. His attention to documentation and relationships with AMCs and service platforms handle the operational side of investing, so clients don't have to.",
    phone: "+91 9999790011",
